% Impinging sweeping jet example (Robledo et al., Exp. Therm. Fluid Sci. 169
% (2025) 111526). Download the test case (Thot.mat, Tcold.mat, Resolution.mat,
% TestConditions.mat) from the link in the README and place the files next to
% CONF_DATA.STR in the folder given by "path".
clc; close all; clear
here = fileparts(mfilename('fullpath'));
addpath(fullfile(here,'..','..','src'))
addpath(fullfile(here,'..','..','utils'))

path = fullfile(here,'SJ_processing',filesep);
